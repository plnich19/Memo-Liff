    ...
    return (
      <table>
        ...
        >
          ...
          <button className="insideModalButton" onClick={this.onCloseEditModal}>
            Cancel
          </button>
        </Modal>
        <Modal
          ...
          return (
            <div>
              <tr key={task.taskId}>
                ...
                {/* <td>{task.assignee}</td> */}
                <td>
                  {moment(task.datetime).format("MMMM Do YYYY, h:mm:ss a")}
                </td>
                <td>
                  <button
      ...
      <div className="yourList">
        ...
        {getYourList.length > 0 ? (
          <table className="yourListTable">
            <tbody>{this.yourTasksTable()}</tbody>
          </table>
        ) : (
          <h1>{dataFetchMsg}</h1>
        )}
